...
class petDashboardHamster extends StatefulWidget {
  const petDashboardHamster({super.key});

  @override
  _PetDashboardState createState() => _PetDashboardState();
}

class _PetDashboardState extends State<petDashboardHamster> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    height: 300,
                    child: isFeeding
                        ? Image.asset('lib/images/hamster.png', fit: BoxFit.cover) // Show feeding image
                        : isGrooming
                        ? Image.asset('lib/images/hamster.png', fit: BoxFit.cover) // Show grooming image
                        : isCuddling
                        ? Image.asset('lib/images/hamster.png', fit: BoxFit.cover) // Show cuddling image
                        : Image.asset('lib/images/hamster.png', fit: BoxFit.cover), // Default cat image
                  ),
                ],
              ),
            ),
...
void main() {
  runApp(MaterialApp(home: petDashboardHamster()));
}
